...
const SingleRequest = ({ request,handleAccept,handleReject }) => {
    ...
    return (
        <div className="card  bg-[#9AD0C2] shadow-xl mx-10 lg:mx-40 my-20 rounded-lg">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-start">
                    {
                        status==="accepted"? <button className="btn  bg-[#265073] text-[#ECF4D6]"><FaRegCheckCircle />Accepted</button>:<button onClick={()=>handleAccept(request)} className="btn  bg-[#265073] text-[#ECF4D6]">Accept</button>
                    }
                    {
                        status==="rejected"? <button className="btn  bg-[#265073] text-[#ECF4D6]"><FaRegCheckCircle />Rejected</button>:<button onClick={()=>handleReject(request)} className="btn bg-[#265073] text-[#ECF4D6]">Reject</button>
                    }
